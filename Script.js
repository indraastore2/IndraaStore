...
<div id="youtube-bg-player" style="position: fixed; bottom: 0; right: 0; z-index: -1;">
    <iframe id="youtube-iframe" width="0" height="0" 
        src="https://www.youtube.com/embed/moZMH3xiW-w?autoplay=1&loop=1&playlist=moZMH3xiW-w&controls=0&mute=1&disablekb=1&rel=0" 
    ...
    <script>
        ...
        const fruitStocks = [
            ...
            { name: "Portal", stock: 4, price: 5000 },
